...
// RandomStream returns a secure cipher.Stream usable as a key stream
...
func NewBlakeKeccackSecp256k1WithRand(r cipher.Stream) *SuiteSecp256k1 {
	suite := new(SuiteSecp256k1)
	suite.r = r
	return suite
}
